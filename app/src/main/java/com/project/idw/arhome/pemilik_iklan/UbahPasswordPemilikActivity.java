...
public class UbahPasswordPemilikActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ubah_password_pemilik);
    ...
    private void update_password() {
        ...
        if (isEmpty == false){
            apiService.updatePasswordPemilik(id,
                    password).enqueue(new Callback<ResponseUpdatePemilik>() {
                @Override
                public void onResponse(Call<ResponseUpdatePemilik> call, Response<ResponseUpdatePemilik> response) {
                    ...
                    if (response.isSuccessful()){
                        ...
                        if (response.body().getCode()==1){
                            Intent intent = new Intent(UbahPasswordPemilikActivity.this, MainActivity.class);

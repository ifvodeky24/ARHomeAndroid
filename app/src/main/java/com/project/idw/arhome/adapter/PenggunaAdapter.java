...
public class PenggunaAdapter extends RecyclerView.Adapter<PenggunaAdapter.ViewHolder> {
    ...
    private List<Pengguna> datalist;

    public PenggunaAdapter(Context mContext, List<Pengguna> datalist){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, final int i) {
        ...
        return new PenggunaAdapter.ViewHolder(view);
    }
...
//                .centerCrop()
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(MessageActivity.KEY_ID, datalist.get(i).getIdPengguna());
                intent.putExtra(MessageActivity.KEY_NAMA_LENGKAP_PENGGUNA, datalist.get(i).getNamaLengkap());
                intent.putExtra(MessageActivity.KEY_FOTO_PENGGUNA, datalist.get(i).getFoto());
                intent.putExtra(Pengguna.TAG_ID, datalist.get(i).getIdPengguna());

...
import com.project.idw.arhome.reminder.DailyAlarmReminderKos;
...
public class DetailKosActivity extends AppCompatActivity {
    ...
    public DailyAlarmReminderKos dailyAlarmReminderKos = new DailyAlarmReminderKos();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int EXTRA_ID_KOS = getIntent().getIntExtra(KosDetail.TAG_ID, 0);

//       Toast.makeText(getApplicationContext(), "EXTRA_ID_KOS: "+EXTRA_ID_KOS, Toast.LENGTH_SHORT).show();
        apiInterface.kosById(String.valueOf(EXTRA_ID_KOS)).enqueue(new Callback<ResponseKosDetail>() {
            ...
            public void onResponse(Call<ResponseKosDetail> call, Response<ResponseKosDetail> response) {
                if (response.isSuccessful()){
                    ...
                    Picasso.with(DetailKosActivity.this)
                    ...
                    if (!sessionManager.isLoggedIn()) {
                        ...
                        btn_booking_kos.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(DetailKosActivity.this);
...
//                }
                ...
                alertDialogBuilder
                        ...
                        .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent intent = new Intent(DetailKosActivity.this, MessageActivity.class);
                        ...
                        .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (mapIntent.resolveActivity(getPackageManager()) != null) {
                                    ...
                                    Toast.makeText(DetailKosActivity.this, "Google Maps Belum Terinstal. Install Terlebih dahulu.",
            ...
            public void onResponse(Call<ResponseBookingKos> call, Response<ResponseBookingKos> response) {
                if (response.isSuccessful()){
                    if (response.body().getCode()==1){
                        Intent detail_pemesanan_kos = new Intent(DetailKosActivity.this, PemesananKontrakanKosActivity.class);
                    ...
                    dailyAlarmReminderKos.setRepeatingAlarm(DetailKosActivity.this);
                }
            }
    ...
    private void goToDaftarKontrakanKosActivity() {
        ...
        Intent intent = new Intent(DetailKosActivity.this, DaftarKontrakanKosActivity.class);

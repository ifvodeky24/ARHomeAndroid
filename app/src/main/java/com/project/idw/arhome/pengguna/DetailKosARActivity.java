...
public class DetailKosARActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_kos_ar);
        ...
        final String EXTRA_ID_KOS = getIntent().getStringExtra(RekomendasiKoses.TAG_ID);
        ...
        apiInterface.kosById(String.valueOf(EXTRA_ID_KOS)).enqueue(new Callback<ResponseKosDetail>() {
            ...
            public void onResponse(Call<ResponseKosDetail> call, Response<ResponseKosDetail> response) {
                if (response.isSuccessful()) {
                    ...
                    Picasso.with(DetailKosARActivity.this)
                    ...
                    if (!sessionManager.isLoggedIn()) {
                        ...
                        btn_booking_kos.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(DetailKosARActivity.this);
...
//                }
                ...
                alertDialogBuilder
                        ...
                        .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent intent = new Intent(DetailKosARActivity.this, MessageActivity.class);
                        ...
                        .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (mapIntent.resolveActivity(getPackageManager()) != null) {
                                    ...
                                    Toast.makeText(DetailKosARActivity.this, "Google Maps Belum Terinstal. Install Terlebih dahulu.",
            ...
            public void onResponse(Call<ResponseBookingKos> call, Response<ResponseBookingKos> response) {
                if (response.isSuccessful()){
                    if (response.body().getCode()==1){
                        Intent detail_pemesanan_kos = new Intent(DetailKosARActivity.this, PemesananKontrakanKosActivity.class);
    ...
    private void goToPoiBrowserActivity() {
        //Fungsi kembali ke main activity dan tidak kembali lagi ke activity ini
        Intent intent = new Intent(DetailKosARActivity.this, PoiBrowserActivity.class);

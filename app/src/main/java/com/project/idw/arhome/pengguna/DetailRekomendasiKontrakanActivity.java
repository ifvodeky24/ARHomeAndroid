...
public class DetailRekomendasiKontrakanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_rekomendasi_kontrakan);
        ...
        final int EXTRA_ID_KONTRAKAN = getIntent().getIntExtra(RekomendasiKontrakans.TAG_ID, 0);
            ...
            public void onResponse(Call<ResponseKontrakanDetail> call, Response<ResponseKontrakanDetail> response) {
                if (response.isSuccessful()) {
                    if (response.body().getMaster().size()>0){
                        ...
                        Picasso.with(DetailRekomendasiKontrakanActivity.this)
                        ...
                        if (!sessionManager.isLoggedIn()) {
                            ...
                            btn_booking.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(DetailRekomendasiKontrakanActivity.this);
                ...
                alertDialogBuilder
                        ...
                        .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent intent = new Intent(DetailRekomendasiKontrakanActivity.this, MessageActivity.class);
                        ...
                        .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (mapIntent.resolveActivity(getPackageManager()) != null) {
                                    ...
                                    Toast.makeText(DetailRekomendasiKontrakanActivity.this, "Google Maps Belum Terinstal. Install Terlebih dahulu.",
...
//        Toast.makeText(getApplicationContext(), "Melakukan Booking", Toast.LENGTH_SHORT).show();
            ...
            public void onResponse(Call<ResponseBookingKontrakan> call, Response<ResponseBookingKontrakan> response) {
                if (response.isSuccessful()){
                    if (response.body().getCode()==1){
                        Intent detail_pemesanan_kontrakan = new Intent(DetailRekomendasiKontrakanActivity.this, PemesananKontrakanKosActivity.class);
    ...
    private void goToRekomendasiKontrakanKosActivity() {
        //Fungsi kembali ke main activity dan tidak kembali lagi ke activity ini
        Intent intent = new Intent(DetailRekomendasiKontrakanActivity.this, RekomendasiKontrakanKosActivity.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        goToRekomendasiKontrakanKosActivity();
    }
}
